...
void Core300sComponent::defer_publish_text(const std::string &defer_id,
...
void Core300sComponent::defer_publish_number(
...
void Core300sComponent::process_packet()  {
    ...
    switch (packet_type) {
        ...
        case 0x013140:
            ...
            defer_publish_text("pub_fw", textsensor_mcu_fw, buf);
